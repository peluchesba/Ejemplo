...
<html lang="zxx">
  <head>
    <title>Pets-Paw an Animals Category Flat Bootstrap Responsive web Template|service :: w3layouts</title>
    <!--meta tags -->
    <meta charset="UTF-8">
  ...
  <body>
    ...
    <section class="service-two py-lg-4 py-md-3 py-sm-3 py-3">
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Pice Table</h3>
        <div class="row w3pvt-service-grids-all text-center">
          <div class="col-lg-4 col-md-4 pricing-grid grid-one">
            <div class=" w3ls-bottom">
              ...
              <h4 class="pt-3"> 900<span class="sup">$</span> </h4>
              <div class="outs_more-book">
                <a href="/booking">Book now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 pricing-grid grid-two">
            <div class=" w3ls-bottom">
              ...
              <h4 class="pt-3">850<span class="sup">$</span> </h4>
              <div class="outs_more-book">
                <a href="/booking">Book now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 pricing-grid grid-three">
            <div class=" w3ls-bottom">
              ...
              <h4 class="pt-3">750<span class="sup">$</span> </h4>
              <div class="outs_more-book">
                <a href="/booking">Book now</a>
              </div>
            </div>
