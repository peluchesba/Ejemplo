...
<html lang="zxx">
  <head>
    <title>Pets-Paw an Animals Category Flat Bootstrap Responsive web Template|Booking :: w3layouts</title>
    <!--meta tags -->
    <meta charset="UTF-8">
  ...
  <body>
    ...
    <section class="booking py-lg-4 py-md-3 py-sm-3 py-3">
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Pets Booking</h3>
        <div class="reserved-table">
          <form action="#" method="post">
            ...
            <button type="submit" class="btn btn-block sent-butnn">Booking</button>
          </form>
        </div>
      </div>
    </section>
